...
public class WavFileTest
{
    ...
    public void testAudioFileExplicitGood()
    {
        ...
        assertTrue( file.getPathName().equals( "lab" ) );
    ...
    {
        WavFile file = new WavFile( null, null, null, 100, null, -12 );
        ...
        assertTrue( file.getTrack() == 0 );
        assertTrue( file.getPathName().equals( "" ) );
        assertTrue( file.getLength() == 0 );
    ...
    /**
     * Test method for {@link AudioFile#getPathName()} 
     * - test getPathName string 
     * 
    ...
    {
        AudioFile mp3 = new WavFile ("asd", "asd", "ad", 1, "this/is/the/path"
                , 2834);
    ...
    /**
     * Test method for {@link AudioFile#setArtist()} - test good artist
     * 
     * **RAC (PA3) - changes audioFile type to WavFile
     */
    @Test
    ...
    /**
     * Test method for {@link AudioFile#setPathName()} - test bad pathName
     * 
     * **RAC (PA3) - added to test
     */
    public void testSetPathNameBad()
    {
        AudioFile file = new WavFile("a", "a", "e", 4, "", 90);
        
        file.setPathName( null );
        
        assertNotNull( file.getPathName() );
        assertTrue(file.getPathName().equals( "" ) );
    }
     ...
     * **RAC (PA3) - added to test
     */
    public void testSetPathNameGood()
    {
        AudioFile file = new WavFile("a", "a", "e", 4, "", 90);
        
        file.setPathName( "/this/is/a/path" );
        
        assertNotNull( file.getPathName() );
        assertTrue(file.getPathName().equals( "/this/is/a/path" ) );
    }
