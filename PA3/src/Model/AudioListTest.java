...
public class AudioListTest
{
    ...
    public void testOrdering()
    {
        ...
        AudioFile test2 = new WavFile( "abc", "def", "abc", 2, "kkd", 3453 );
        AudioFile test3 = new MP3File( "abc", "def", "", 0, "ade", "e", 234 );
     ...
     * **RAC (PA3) - changed type of audioFile to MP3
     */
    @Test
    public void testRemove()
    {
        ...
        for ( int i = 0; i < 33; i++ )
            list.add( new MP3File( i + "", i + "", "", 0, i + "", "", 0) );
     ...
     * 
     * **MLN (PA2) - new for PA2
     * **RAC (PA3) - changed type of audioFile to WAV
     */
    @Test
    public void testRemoveFile()
    {
        ...
        for ( int i = 0; i < 33; i++ )
            list.add( new WavFile( i + "", i + "", "", 0,  i + "", 98 ) );
    ...
    public void testRemoveFileNull()
    {
        ...
        for ( int i = 0; i < 33; i++ )
            list.add( new WavFile( i + "", i + "", "", 0,  i + "", 0 ) );
     ...
     */
    @Test
    public void testUnionWAV()
    {
        AudioFile test1 = new WavFile( "abc", "def", "", 0, "a", 0 );
        AudioFile test2 = new WavFile( "lmn", "opq", "", 0, "b", 23 );
        AudioFile test3 = new WavFile( "xyz", "abc", "", 0, "c", 456 );
     ...
     * Test method for {@link AudioList#union(AudioList)} 
     * 
     * **RAC (PA3) - Changed added method for testing MP3
     */
    @Test
    public void testUnionMP3()
    {
        AudioFile test1 = new MP3File( "abc", "def", "", 0, "a", "", 0 );
        AudioFile test2 = new MP3File( "lmn", "opq", "", 0, "b", "", 23 );
        AudioFile test3 = new MP3File( "xyz", "abc", "", 0, "c", "", 456 );
