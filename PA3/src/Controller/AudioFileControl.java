 ...
 * 
 * **RAC PA3 (3/29/2013) - moved the searching for the new files to this class
 * 
 * @author Ryan Carter, Michael Norton
 * @version PA3 (3/29/2013), PA2 (2/12/2013)
 */
public class AudioFileControl 
{
    ...
    */
     ...
     * @param choice
     * @param directory
     * @return the the list of audioFiles
     */
     ...
     * 
     * **RAC PA3 (3/29/2013) - added to AudioFileControl
     * 
     * @param file
     */
    private void addMP3(File file)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                path = file.getPath();
                bitrate = (int) f.getAudioHeader().getBitRateAsNumber();
            }
     ...
     * 
     * **RAC (PA3) - added to AudioFileControl.
     * 
